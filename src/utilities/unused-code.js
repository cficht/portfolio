...
//   airplaneObject: new THREE.Vector3(-3500 * (setWidth / 1440), 1300, -4000),
//   treeObject: new THREE.Vector3(-3500 * (setWidth / 1440), -1800, -4000),
//   grassObject: new THREE.Vector3(3500, -1800, -4000),
//   cssObject: new THREE.Vector3(0, 100, -2000),
//   planeObject: new THREE.Vector3(0, 100, -2000),
//   frameObject: new THREE.Vector3(0, 100, -2000),
//   nameObject: new THREE.Vector3(-10, 200, -2000),
//   titleObject: new THREE.Vector3(0, 0, -2000),
