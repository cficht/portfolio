...
import { createGlRenderer, createCssRenderer, createPlane, createProjectCssObject, createColoredMaterial } from '../../utilities/initialize-scene';
  ...
  function create3dPage(width, height, position, rotation, number, colors) {  
    ...
    if(nameObject) {
      ...
      fontLoader.load('./fonts/helvetiker_regular.typeface.json', function(font) {
        ...
        mesh.position.set(defPos.nameObject.x, defPos.nameObject.y, defPos.nameObject.z);
        nameObject = mesh;
        glScene.add(mesh);
      });
    }
